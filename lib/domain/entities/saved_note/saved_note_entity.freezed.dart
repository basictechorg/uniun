...
@useResult
$Res call({
 String eventId, String sig, String authorPubkey, String content, NoteType type, List<String> eTagRefs, List<String> pTagRefs, List<String> tTags, DateTime created, DateTime savedAt, int cachedReplyCount, int referenceCount, String? sourceChannelId, String? sourcePrivateGroupId, String? quoteEventId, NoteEntity? quotedNote, List<MediaBlobEntity> attachments
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String eventId,  String sig,  String authorPubkey,  String content,  NoteType type,  List<String> eTagRefs,  List<String> pTagRefs,  List<String> tTags,  DateTime created,  DateTime savedAt,  int cachedReplyCount,  int referenceCount,  String? sourceChannelId,  String? sourcePrivateGroupId,  String? quoteEventId,  NoteEntity? quotedNote,  List<MediaBlobEntity> attachments)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SavedNoteEntity() when $default != null:
return $default(_that.eventId,_that.sig,_that.authorPubkey,_that.content,_that.type,_that.eTagRefs,_that.pTagRefs,_that.tTags,_that.created,_that.savedAt,_that.cachedReplyCount,_that.referenceCount,_that.sourceChannelId,_that.sourcePrivateGroupId,_that.quoteEventId,_that.quotedNote,_that.attachments);case _:
  return orElse();
...
@override
int get hashCode => Object.hash(runtimeType,eventId,sig,authorPubkey,content,type,const DeepCollectionEquality().hash(_eTagRefs),const DeepCollectionEquality().hash(_pTagRefs),const DeepCollectionEquality().hash(_tTags),created,savedAt,cachedReplyCount,referenceCount,sourceChannelId,sourcePrivateGroupId,quoteEventId,quotedNote,const DeepCollectionEquality().hash(_attachments));
